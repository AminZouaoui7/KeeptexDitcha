...
async function testUpdateEtat(token) {
  try {
    console.log('\nTest de mise à jour de l\'état à "annulee"');
    console.log('Token utilisé:', token);
    
    // Récupérer la liste des commandes pour vérifier les IDs disponibles
    ...
    const commandeId = commandes.length > 0 ? commandes[0].id : 1;
    console.log(`\nUtilisation de la commande ID: ${commandeId} pour le test`);
    
    // Tester la mise à jour de l'état
    console.log('\nTentative de mise à jour de l\'état à "annulee"...');
